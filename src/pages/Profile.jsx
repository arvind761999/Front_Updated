      ...
      <div className="grid lg:grid-cols-2 gap-8 md:px-24 p-4 sm:py-8">
        <div className="flex flex-col justify-center items-center lg:py-24 py-10 gap-5 md:m-20 m-5 rounded-lg bg-white p-6 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]">
          ...
          <div className="text-center mx-6 pt-3">
            ...
            <h3 className="text-red-500 text-xl font-bold">1500</h3>
          </div>
          <div className="text-center">
            <h1 className="text-lg font-bold">Account Status</h1>
            <h3 className="text-red-500 text-xl font-bold">red</h3>
          </div>
        </div>
        <div className="flex flex-col justify-center items-start gap-5 rounded-lg bg-white p-6">
          <h1 className="text-3xl font-bold">My Profile</h1>
          <h3 className="text-red-500 text-xl font-bold">{user.type}</h3>
          ...
          <div className="flex flex-col md:flex-row gap-5 mt-14">
            <button
              className="bg-red-500 py-3 px-6 rounded-lg text-white font-bold hover:bg-red-600 transition duration-200 ease-in-out"
              onClick={getUser}
            >
              Update Profile
            </button>
            {user.type === "eventOrganizer" && (
              <>
                <Link to="/pending-reservations">
                  <button className="bg-red-500 py-3 px-6 rounded-lg text-white font-bold hover:bg-red-600 transition duration-200 ease-in-out">
            ...
            {user.isAdmin && (
              <>
                <Link to="/pending-activities">
                  <button className="bg-red-500 p-3 rounded-xl text-white font-bold">
                    Pending Activities
                  </button>
                </Link>
              </>
