...
const AddTourPackage = () => {
  ...
  const tourDetails = state.data.oneTour;
  console.log(tourDetails);
  //store database states
  const [file, setFile] = useState("");
  const [name, setName] = useState(tourDetails.name);
  const [category, setCategory] = useState(tourDetails.category);
  const [price, setPrice] = useState(tourDetails.price);
  const [groupCount, setGroupCount] = useState(tourDetails.groupCount);
  const [languages, setLanguages] = useState(tourDetails.languages);
  const [duration, setDuration] = useState(tourDetails.duration);
  const [cities, setCities] = useState(tourDetails.cities);
  const [description, setDesc] = useState(tourDetails.description);
  const [introduction, setIntroduction] = useState(tourDetails.introduction);
      ...
      <form>
        <div className="space-y-12">
          ...
          <div>
              ...
              <div className="mt-10 flex flex-row">
                ...
                <div className="basis-2/3">
                  <img
                    ...
                    src={
                      file ? URL.createObjectURL(file) : `${tourDetails.img}`
                    }
                    alt="avatar"
                  />
                </div>
            ...
            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <select
                    defaultValue={tourDetails.category}
                    id="category"
                    name="category"
                    className="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    onChange={(e) => {
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    defaultValue={tourDetails.groupCount}
                    type="number"
                    id="maxsize"
                    name="maxsize"
                    className="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <input
                    defaultValue={tourDetails.languages}
                    type="text"
                    name="languages"
                    id="languages"
                    placeholder="Type Here"
              ...
              <div className="sm:col-span-3">
                ...
                <div className="mt-2">
                  <select
                    defaultValue={tourDetails.duration}
                    id="duration"
                    name="duration"
                    className="block w-full px-3 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    onChange={(e) => {
              ...
              <div className="col-span-full">
                ...
                <div className="mt-2">
                  <input
                    defaultValue={tourDetails.cities}
                    type="text"
                    name="places"
                    id="places"
          ...
          <div className="col-span-full">
            ...
            <div className="mt-2">
              <textarea
                defaultValue={tourDetails.introduction}
                rows={10}
                type="text"
                name="intro"
                id="intro"
