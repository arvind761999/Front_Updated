...
// import { FontAwesomeIcon,faCalendarDays } from "@fortawesome/fontawesome-free";
...
//   const [Hoteltype, setHotelType] = useState("");
  ...
  const date = useMemo(() => ({ checkInDate, checkOutDate }), [checkInDate, checkOutDate]);
  ...
  }, [data, navigate,date, search, searchClicked]);
...
//       navigate('/hotelhome', { state: { date, data } });
//     }
//   }, [data, navigate, search, searchClicked]);
